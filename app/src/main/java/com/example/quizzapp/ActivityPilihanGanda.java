...
import com.example.quizzapp.model.SoalPilGan;

public class ActivityPilihanGanda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ketika button submit diklik akan mengecek jawaban
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(ActivityPilihanGanda.this, ActivityScore.class);
