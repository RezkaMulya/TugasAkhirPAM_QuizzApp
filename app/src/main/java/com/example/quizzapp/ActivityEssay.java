...
import com.example.quizzapp.model.SoalEssay;

public class ActivityEssay extends AppCompatActivity {
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(ActivityEssay.this, ActivityScore.class);
